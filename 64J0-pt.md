...
Atualmente estou trabalhando em tarefas mais focadas no back-end, utilizando principalmente o Node.js para desenvolver as aplicações em conjunto com bancos de dados relacionais. Devido a estas últimas experiências adquiri conhecimentos em algumas tecnologias do nicho de streaming, citando algumas: [Wowza](https://www.wowza.com/) e [FFmpeg](https://ffmpeg.org/).
